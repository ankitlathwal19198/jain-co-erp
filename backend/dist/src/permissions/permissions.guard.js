...
let PermissionsGuard = class PermissionsGuard {
    ...
    canActivate(context) {
        const required = this.reflector.getAllAndOverride(require_permissions_decorator_1.PERMISSIONS_KEY, [context.getHandler(), context.getClass()]);
        ...
        if (user.roleName === permissions_catalog_1.SUPER_ADMIN_ROLE)
            return true;
